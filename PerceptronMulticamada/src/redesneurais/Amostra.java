...
public class Amostra {
    ...
    static {
        valores = new double[200][4];
        saidas = new double[200];
        amostras = new double[20][4];
        int cont = 0;
        
        try {
            Scanner s = new Scanner(new File("/Users/rafaelsakurai/Documents/Estudos/Redes Neurais Artificiais/PerceptronMulticamada/src/treinamento"));
            ...
            cont = 0;
            Scanner s2 = new Scanner(new File("/Users/rafaelsakurai/Documents/Estudos/Redes Neurais Artificiais/PerceptronMulticamada/src/amostras"));
