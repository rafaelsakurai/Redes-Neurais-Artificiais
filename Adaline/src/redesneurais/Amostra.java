...
public class Amostra {
    ...
    static {
        valores = new double[35][5];
        saidas = new double[35];
        amostras = new double[15][5];
        int cont = 0;
        
        try {
            Scanner s = new Scanner(new File("/Users/rafaelsakurai/Documents/Estudos/Redes Neurais Artificiais/Adaline/src/treinamento"));
            ...
            while(s.hasNextLine()) {
                ...
                valores[cont][4] = Double.valueOf(dados[4]);
                saidas[cont] = Double.valueOf(dados[5]);
                cont++;
            }
            
            cont = 0;
            Scanner s2 = new Scanner(new File("/Users/rafaelsakurai/Documents/Estudos/Redes Neurais Artificiais/Adaline/src/amostras"));
            ...
            while(s2.hasNextLine()) {
                ...
                amostras[cont][4] = Double.valueOf(dados[4]);
                cont++;
            }
